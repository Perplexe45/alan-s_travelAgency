/* global ionos_performanceadmin_bar_flush_ajax_object */
( function() {
    var is_flushing = false,
        admin_bar_ionos_performancelist_item = document.getElementById( 'wp-admin-bar-ionos-performance' ),
        flush_link = admin_bar_ionos_performancelist_item.querySelector( 'a.ab-item' ),
    ...
    var admin_bar_icon = admin_bar_ionos_performancelist_item.querySelector( '#wp-admin-bar-ionos-performance .ab-icon' );
    ...
    function flush( event ) {
        ...
        is_flushing = true;
        aria_live_area.textContent = ionos_performanceadmin_bar_flush_ajax_object.flushing;
        ...
        request.addEventListener( 'load', function() {
            if ( this.status === 200 ) {
                ...
                flush_icon_remove_classes();
                admin_bar_icon.classList.add( 'animate-fade' );
                admin_bar_icon.classList.add( ionos_performanceadmin_bar_flush_ajax_object.dashicon_success );
                aria_live_area.textContent = ionos_performanceadmin_bar_flush_ajax_object.flushed;
                return;
            }
        ...
        request.open( 'DELETE', ionos_performanceadmin_bar_flush_ajax_object.url );
        request.setRequestHeader( 'X-WP-Nonce', ionos_performanceadmin_bar_flush_ajax_object.nonce );
        request.send();
    }
}() );